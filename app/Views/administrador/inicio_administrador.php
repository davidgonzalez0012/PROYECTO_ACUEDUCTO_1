...
<div id="dashboard" class="page active">
    ...
    <div class="row justify-content-center g-4 mb-4">
        ...
        <div class="col-12 col-md-3">
            <div class="card glass-card border-0 h-100">
            <a href="<?= base_url('tickets/resueltoshoy/admin') ?>" class="text-decoration-none">
                    <div class="card-body text-center p-4">
        ...
        <div class="col-12 col-md-3">
            <div class="card glass-card border-0 h-100">
                <a href="<?= base_url('tickets/resueltos/admin') ?>" class="text-decoration-none">
                    <div class="card-body text-center p-4">
        ...
        <div class="col-12 col-md-3">
            <div class="card glass-card border-0 h-100">
                <a href="<?= base_url('tickets/alta_prioridad/admin') ?>" class="text-decoration-none">
                    <div class="card-body text-center p-4">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card glass-card border-0">
                <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= base_url('tickets/todos') ?>" class="btn btn-sm btn-primary">
                        Ver Todos
                    </a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php if (!empty($recientes)): ?>
                                    <?php foreach ($recientes as $ticket): ?>
                                        <?php if ($ticket['ESTADO'] === 'ABIERTO' || $ticket['ESTADO'] === 'EN PROCESO'): ?>
                                            <tr>
                                                <td>#<?= esc($ticket['ID']) ?></td>
                ...
                <div class="card-body">
                    <div class="mb-4">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="badge bg-primary"><?= esc($hardwarePct) ?>%</span>
                        </div>
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar bg-primary" style="width: <?= $hardwarePct ?>%"></div>
                        </div>
                    </div>
                    <div class="mb-4">
                        <div class="d-flex justify-content-between mb-2">
                            <span class="fw-bold">Software</span>
                            <span class="badge bg-success"><?= $softwarePct ?>%</span>
                        </div>
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar bg-success" style="width: <?= $softwarePct ?>%"></div>
                        </div>
                    </div>
                    <div class="mb-4">
                        <div class="d-flex justify-content-between mb-2">
                            <span class="fw-bold">Redes</span>
                            <span class="badge bg-warning"><?= $redesPct ?>%</span>
                        </div>
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar bg-warning" style="width: <?= $redesPct ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
